...
Developed by Sebastian Andrade Roa
...
The backend and frontend will be running locally. The PostgreSQL database is started automatically as part of the Docker Compose setup — no manual configuration required.
